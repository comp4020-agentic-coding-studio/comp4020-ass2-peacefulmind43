...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP3251",
  title: "The Formal Theory of Poker",
  session: "Semester 1",
  year: 2027,
  level: 3,
  ...
  endDate: "2027-05-28",
  description:
    "A formal treatment of poker: hand combinatorics, equity, game-theoretic " +
    "equilibria and bankroll mathematics, testing how much of 'good instincts' " +
    "at the table actually survives translation into a provable claim.",
  tags: ["poker", "game theory", "probability"],
